...
const handleRegister = (formData:FormData) => {
        ...
        console.log('name',name, 'password', password,'confirm password',confirmPassword);
     
}
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <h1 className="mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-xl lg:text-xl dark:text-white">Register</h1>
      <form action={handleRegister} className="block  p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 lg:w-3/6  md:w-4/6  w-5/6 ">
        <Fragment>
        ...
        <Fragment>
          ...
          <div className="relative mb-6">
            ...
            <input name="password" type="text" id="input-group-2" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="namE123@"/>
          </div>
        </Fragment>
        <Fragment>
          <label htmlFor="input-group-3" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm Your password</label>
          <div className="relative mb-6">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
               {/* <i className='fas fa-key text-red-400' style={{fontSize:'24px'}}></i> */}
               <RiLockPasswordLine className="text-red-400"  />
            </div>
            <input name="confirm password" type="text" id="input-group-3" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="namE123@"/>
          </div>
        </Fragment>
